...
import com.droidinteractive.colorpicker.ColorPickerDialog.OnColorPickerListener;
...
public class CustomElementBasicActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        baseElementField = (Spinner) findViewById(R.id.ce_base_particle);
        ...
        lowerElementField = (Spinner) findViewById(R.id.ce_lower_particle);
        higherElementField = (Spinner) findViewById(R.id.ce_higher_particle);
        ...
        elementAdapter = ArrayAdapter.createFromResource(this, R.array.particles_list, android.R.layout.simple_spinner_item);
    ...
    public void writePropertiesToCustom()
    {
        ...
        if (newElement)
        {
            mCustomElement.setFilename(nameField.getText().toString().toLowerCase(Locale.getDefault()));
        }
        ...
        if (!(collisions == null && !newElement))
        {
            ...
            int numElements = getResources().getStringArray(R.array.particles_list).length;
    ...
    private ColorPickerDialog makeColorPickerDialog(int color) {
        // initialColor is the initially-selected color to be shown in the rectangle on the left of the arrow.
        // for example, 0xff000000 is black, 0xff0000ff is blue. Please be aware of the initial 0xff which is the alpha.
        return new ColorPickerDialog(this, color , new OnColorPickerListener() {
                @Override
